...
namespace rst {
    ...
    public:
        ...
        Eigen::Vector3f get_pixed(Eigen::Vector3f&);

        void set_pixel(const Eigen::Vector3f& point, const Eigen::Vector3f& color);

        void set_temp_pixel(const Eigen::Vector3f& point, const Eigen::Vector3f& color);
    ...
    private:
        ...
        std::vector<Eigen::Vector3f> temp_frame_buf;
